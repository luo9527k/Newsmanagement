<template>
    <div class="news">
        ...
        <el-form-item label="类别" prop="category">
            <el-select v-model="newsForm.category" class="m-2" placeholder="Select" size="small">
         ...
         <el-form-item>
        <el-button class="btn" type="primary" @click="submitForm()">修改新闻</el-button>
        </el-form-item>
        </el-form>
    </div>
</template>
...
const newsForm = reactive({
    title: "",
    content: "",
    category: 1 ,//1表示最新动态 2典型案例 3通知公告
    cover: "",
    file: null,
